...
function start_load_data(hexo) {
    return new Promise(function (resolve, reject) {
        ...
        // 复制手册资源
        // 暂时直接复制到 assets 文件夹下面
        if (!fs.existsSync(hexo.public_dir + '/assets')) {
            fs.copyDir(hexo.docsgen.assetDir, hexo.public_dir+'/assets');
        }
...
function init_sphinx_config(hexo) {
    ...
    hexo.docsgen.assetDir = config.project_source_dir + "/doc/developer_manual/assets";
